...
PRED = Path(r".\results\q2_v4\runs_b1\gnn\predictions")
FROZEN = Path(r".\results\q2_v4\audit\delta_primary_frozen_b1.json")
SPLIT = "b1_group"; SEEDS = list(range(10))
...
def _pre_freeze_evidence():
    ...
    bs = Path("results/q2_v4/runs_b1/bootstrap")
