...
NAIVE = R / "runs_b1" / "naive" / "predictions"
REP = R / "runs_b1" / "lgbm" / "predictions"
FROZEN = R / "audit" / "delta_det_frozen_b1.json"
SPLIT = "b1_group"; N_BOOT = 2000
